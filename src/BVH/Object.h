...
struct Object {
    Object() {
        transform = inverseTransform = normalTransform = inverseNormalTransform = glm::mat4x4(1.f);
    }
    virtual ~Object(){}
  ...
  virtual glm::vec3 getCentroid() const = 0;
    ...
    virtual void setTransform(const glm::mat4x4 transform) {
        ...
        this->inverseNormalTransform = glm::mat4x4(glm::transpose(glm::inverse(glm::mat3x3(transform))));
    }
